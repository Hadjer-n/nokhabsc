...
const ThreeDGlobe = () => {
  ...
  useEffect(() => {
    ...
    const drawGlobe = () => {
      ...
      gradient.addColorStop(0.7, 'rgba(0, 149, 255, 0.4)');
      ...
      const continents = [
        { x: centerX - radius * 0.3, y: centerY - radius * 0.1, size: radius * 0.4 }, 
        { x: centerX + radius * 0.2, y: centerY - radius * 0.2, size: radius * 0.5 }, 
        { x: centerX + radius * 0.4, y: centerY + radius * 0.3, size: radius * 0.3 }, 
      ];
